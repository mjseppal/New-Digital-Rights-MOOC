...
- [ask for erasing data held of you]
- [restrict using some of your data]
- [deny using any of your data]
- [to move your personal data to other services]
- [not to be subject to decisions made only by machines]
- [know if your personal data has been breached within 72 hours]
